        ...
        if (response.ok) {
          ...
          const transformedRoadmap: RoadmapData = {
            ...
            phases: (rawRoadmap.phases || []).map((phase: any, index: number) => ({
              ...
              understanding_score: phase.understanding_score || 0,
              why_it_matters: phase.description || phase.why_it_matters || `Critical ${rawRoadmap.job_title} skills with high interview frequency.`,
              skills: (phase.skills || []).map((skill: any) => ({
                ...
                interview_frequency: skill.interview_frequency || 75,
